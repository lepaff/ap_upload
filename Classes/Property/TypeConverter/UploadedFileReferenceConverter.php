<?php
namespace AP\ApUpload\Property\TypeConverter;
...
//    }
            ...
            if (isset($source['submittedFile']['resourcePointer'])) {
                try {
                    ...
                    if (strpos($resourcePointer, 'file:') === 0) {
                        ...
                        return $this->createFileReferenceFromFalFileObject($resourceFactory->getFileObject($fileUid));
                    } else {
                        return $this->createFileReferenceFromFalFileReferenceObject($resourceFactory->getFileReferenceObject($resourcePointer), $resourcePointer);
                    }
    ...
    protected function importUploadedResource(array $uploadInfo, PropertyMappingConfigurationInterface $configuration)
    {
        ...
        $allowedFileExtensions = $configuration->getConfigurationValue('AP\\ApUpload\\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_ALLOWED_FILE_EXTENSIONS);
        ...
        $uploadFolderId = $configuration->getConfigurationValue('AP\\ApUpload\\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_FOLDER) ?: $this->defaultUploadFolder;
        ...
        $conflictMode = $configuration->getConfigurationValue('AP\\ApUpload\\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_CONFLICT_MODE) ?: $defaultConflictMode;

        $resourceFactory = GeneralUtility::makeInstance(ResourceFactory::class);
        $uploadFolder = $resourceFactory->retrieveFileOrFolderObject($uploadFolderId);
     ...
     * @return \AP\ApUpload\Domain\Model\FileReference
     */
    ...
    protected function createFileReferenceFromFalFileReferenceObject(FalFileReference $falFileReference, $resourcePointer = null)
    {
        if ($resourcePointer === null) {
            /** @var $fileReference \AP\ApUpload\Domain\Model\FileReference */
